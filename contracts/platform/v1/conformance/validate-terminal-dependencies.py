...
def validate_ppa() -> int:
    ...
    if not isinstance(vectors["positive_cases"], list) or len(vectors["positive_cases"]) != 15:
    ...
    if len(case_names) != 102 or any(not isinstance(name, str) or not name for name in case_names) or len(set(case_names)) != len(case_names):
